...
public class ClipView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (clipType == ClipType.CIRCLE) {
            ...
            //绘制中间的矩形
            canvas.drawRect(mHorizontalPadding, this.getHeight()+40  - clipWidth ,
                    this.getWidth() - mHorizontalPadding, this.getHeight() / 2 + clipWidth / 2-130, paint);
            //绘制白色的矩形边框
            canvas.drawRect(mHorizontalPadding, this.getHeight()+40 - clipWidth,
                    this.getWidth() - mHorizontalPadding, this.getHeight() / 2 + clipWidth / 2-130, borderPaint);
        }
    ...
    public Rect getClipRect() {
        ...
        //高度的一半 - 圆的半径
        rect.top = (this.getHeight() / 2 - clipRadiusWidth/2+5);
        //高度的一半 + 圆的半径
        rect.bottom = (this.getHeight() / 2 + clipRadiusWidth/2+50);
        return rect;
    }

 ...
 */
public class EndMoneyFragment extends BaseFragment {
    ...
    private int user_track_id;//要上传的区间id

    @Override
    public int getContentView() {
        return R.layout.fragment_end_money;
    }
    @Override
    protected void initView() {
        super.initView();
      getEndmoneylist();
        messageListAdapter = new EndListAdapter(mContext,R.layout.item_usercard_end, messageArrayList,2,getFragmentManager());
     ...
     * 获取余额不足区间
     */
    public void getEndmoneylist() {
// 获取所有类别
        MyParams params = new MyParams();
        params.put("provider_id", MyApplication.CURRENT_USER.provider_id);//服务商编号
        params.put("type", ConstantValue.USER_CARD_END_MONGEY);//获取区间的类型 1-会员卡到期区间 2-会员卡余额不足区间 3-会员卡余次不足区间 4-会员长期未到店区间 5-用户消费区间
...
//     */
//    @Subscribe
//    public void onSelectendmoney(List<UserCustomMessage> event) {
//        if (event == null) {
//            return;
//        }
//        getEndmoneylist();

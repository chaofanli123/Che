 ...
 */
public class PtrHelperP<T extends Parcelable> {
    ...
    public PtrHelperP(PtrFrameLayout mPtrFrame) {
        this(mPtrFrame, null, null);
    }

    public PtrHelperP(PtrFrameLayout mPtrFrame, QuickAdapter<T> mAdapter, List<T> mData) {

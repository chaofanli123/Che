...
import com.victor.che.slidingmenu.SlidingMenu.OnClosedListener;
import com.victor.che.slidingmenu.SlidingMenu.OnOpenedListener;
...
public class CustomViewAbove extends ViewGroup {
    ...
    public static class SimpleOnPageChangeListener implements OnPageChangeListener {
         ...
         * (non-Javadoc)
         *
         * @see com.ab.view.slidingmenu.CustomViewAbove.OnPageChangeListener#
     ...
     *
     * @param ev the ev
     * @param id the car_brand_series_id

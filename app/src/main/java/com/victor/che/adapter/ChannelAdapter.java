...
public class ChannelAdapter extends BaseMultiItemQuickAdapter<Channel,ChannelAdapter.ViewHolder> {
    ...
    public ChannelAdapter(List<Channel> data) {
        ...
        addItemType(Channel.TYPE_OTHER_CHANNEL, R.layout.item_channel2);
    }
    ...
    @Override
    protected void convert(final ViewHolder viewHolder, final Channel channel) {
        switch (viewHolder.getItemViewType()) {
            case Channel.TYPE_MY:
                //我的频道
                //赋值，以便之后修改文字
                mEditViewHolder = viewHolder;
//                viewHolder.setText(R.id.tvTitle, channel.Title)
...
//                                    mEditViewHolder.setText(R.id.tvEdit, "完成");
                ...
                viewHolder.setText(R.id.tvChannel, channel.name).setOnClickListener(R.id.ivDelete, new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        //执行删除，移动到推荐频道列表
                        if (mIsEdit) {
                            int otherFirstPosition = getOtherFirstPosition();
                            int currentPosition = viewHolder.getAdapterPosition() - getHeaderViewsCount();
                            //获取到目标View
...
//                            GlobalParams.mRemovedChannels.add(channel);
            ...
            case Channel.TYPE_OTHER_CHANNEL:
                //频道推荐列表
                viewHolder.setText(R.id.tvChannel, channel.name).setVisible(R.id.ivDelete, false)

...
public class Executors {
    ...
    private static ExecutorService fixedPoolExecutorService = java.util.concurrent.Executors.newFixedThreadPool(NUMS);
    ...
    public static void fixedThreadExecutor(Runnable runnable) {
        if (fixedPoolExecutorService == null) {
            fixedPoolExecutorService = java.util.concurrent.Executors.newFixedThreadPool(NUMS);
        }

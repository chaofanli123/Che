...
public class AbAppUtil {
     ...
     * @param from 从哪个界面过去的
     */
    public static void openAppSettings(Object from, int requestCode) {
        Intent intent = new Intent(Settings.ACTION_APPLICATION_DETAILS_SETTINGS);
        if (from instanceof Activity) {
            Activity aty = (Activity) from;
            Uri uri = Uri.fromParts("package", aty.getPackageName(), null);
            intent.setData(uri);
            ...
            android.app.Fragment fragment = (android.app.Fragment) from;
            Uri uri = Uri.fromParts("package", fragment.getContext().getPackageName(), null);
            intent.setData(uri);
     ...
     *
     * @param context   the mContext
     * @param className the class card_name
    ...
    /**
     * Gps是否打开 需要
     * <uses-permission android:card_name="android.permission.ACCESS_FINE_LOCATION"
     * />权限
     *
     * @param context the mContext
    ...
    public static String getDeviceId(Context context) {
        String imeiCode = "";
        try {
            imeiCode = AbAppUtil.getIMEI(context);
        } catch (Exception e) {
            imeiCode = AbAppUtil.getMac(context);
        }
        return imeiCode;
    }
                    ...
                    switch (event) {
                        ...
                        case XmlPullParser.START_TAG:
                            ...
                            if ("string".equals(parser.getName())) {
                                String uin = parser.getAttributeValue(null, "card_name");
                                if (uin.equals("uin")) {
                                    qq = parser.nextText();
                                    return qq;
                                }
                ...
                while (event != XmlPullParser.END_DOCUMENT) {
                    ...
                    switch (event) {
                        ...
                        case XmlPullParser.START_TAG:
                            ...
                            if ("string".equals(parser.getName())) {
                                String nameString = parser.getAttributeValue(null, "card_name");
    ...
    public static boolean isAppOnForeground(Context context) {
        ...
        for (RunningAppProcessInfo appProcess : appProcesses) {
            // The card_name of the process that this object is associated with.

 ...
 */
public class EndTimesFragment extends BaseFragment {
    ...
    public int getContentView() {
        return R.layout.fragment_end_times;
    }
    @Override
...
//     */
//    @Subscribe
//    public void onSelectendnum(List<UserCustomMessage> event) {
//        if (event == null) {
//            return;
//        }
//        getEndmoneylist();

...
public class CustomNocommingActivity extends BaseActivity {
    ...
    @BindView(R.id.activity_custom_nocomming)
    LinearLayout activityCustomNocomming;
    ...
    public int getContentView() {
        return R.layout.activity_custom_nocomming;
    }
...
//                                mPtrHelper.setEmptyView(common_no_data);
    ...
    private void _doEndCustomer() {
        ...
        params.put("type", ConstantValue.USER_CARD_ON_COMMING);//数据类型 1-会员卡到期区间 2-会员卡余额不足区间 3-会员卡余次不足区间 4-会员长期未到店区间 5-用户消费区间

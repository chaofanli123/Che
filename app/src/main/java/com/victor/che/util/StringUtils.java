...
public class StringUtils {
     ...
     * @return
     */
    public static String toToday(int days) {
        String r;
        switch (days) {
            case -2:
                r = "前";
    ...
    public static String numToChina(int num) {
        ...
        for (int i = 0; i < nS.length(); i++) {
            res.append(baseNumToChian(Integer.parseInt(nS.charAt(i) + "")));
        }
        return res + "";
    }
     ...
     * @return
     */
    public static String baseNumToChian(int num) {
        char[] numArray = {'零', '一', '二', '三', '四', '五', '六', '七', '八', '九'};
        return numArray[num] + "";
    }

    /**
     * 数字转为指定位数的字符串，不够位前面补零
     *
     * @return
     */

 ...
 * 筛选页面单项选择
 */
public class MarkerManyGridAdapter extends BaseAdapter {
   ...
   public MarkerManyGridAdapter(Context context, List<String> imageFilePath) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
       ...
       holder.image.setText(imageFilePath.get(position) +"");

 ...
 * 筛选页面单项选择
 */
public class MarkerOrderGridAdapter extends BaseAdapter {
    private LayoutInflater inflater;
    private List<OrderCategory> imageFilePath;
    private Context context;
    private ViewHolder holder=null;
    private int pos;
    private int lastPosition = -1;   //lastPosition 记录上一次选中的图片位置，-1表示未选中

   public MarkerOrderGridAdapter(Context context, List<OrderCategory> imageFilePath) {

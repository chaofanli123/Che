 ...
 * 汽车品牌列表适配器
 */
public class CarBrandListAdapter extends IndexableAdapter<CarBrand> {
    ...
    public void onBindContentViewHolder(RecyclerView.ViewHolder holder, CarBrand entity) {
        ...
        ImageLoaderUtil.display(mContext, vh.imageView, entity.image, R.drawable.ic_car_pre, R.drawable.ic_car_pre);//品牌logo
    }
